...
export default function FormularioSaidaVeiculo() {
    ...
    useEffect(() => { buscarVeiculos(); buscarPorteiros(); }, []);
                            ...
                            <Form.Group>
                                ...
                                <Dropdown className="w-100">
                                    ...
                                    <Dropdown.Menu className="w-100">
                                        {veiculo.map(item => (<Dropdown.Item key={item.id} onClick={() => setValue("idVeiculo", item.id)}>{item.placa}</Dropdown.Item>))}
                                    </Dropdown.Menu>
                                </Dropdown>
                            </Form.Group>
                        </Col>
                        ...
                        <Col md={12}>
                            <Form.Group>
                                ...
                                <Form.Control
                                    ...
                                    readOnly={!ehEdicao} {...register("km_final_veiculo", { }) }
                                />
                            </Form.Group>
                        </Col>
                    </Row>
                        ...
                        <Col md={6}>
                            <Form.Group>
                                ...
                                <div className="d-flex">
                                    ...
                                    />
                                    <Button className="ms-2" variant="outline-secondary" onClick={() => { setCampoSelecionado("idResponsavel"); setModalAberto(true); }} >Buscar</Button>
                                </div>
                            </Form.Group>
                        </Col>
                            ...
                            <Form.Group>
                                ...
                                <Dropdown className="w-100">
                                    <Dropdown.Toggle
                                        ...
                                        disabled={ehEdicao}
                                    >
                                        {porteiro.find(p => p.id === watch("idPorteiroSaida"))?.nome
                                            || "Selecionar porteiro"}
                                    </Dropdown.Toggle>
                            ...
                            <Form.Group>
                                ...
                                <Dropdown className="w-100">
                                    <Dropdown.Toggle
                                        ...
                                        disabled={!ehEdicao}
                                    >
                                        {porteiro.find(p => p.id === watch("idPorteiroEntrada"))?.nome
                                            || "Selecionar porteiro"}
                                    </Dropdown.Toggle>
