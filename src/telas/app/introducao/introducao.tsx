    ...
    <Container fluid >
      ...
      <Row xs={1} md={3} className="g-4 mb-4" >
        ...
        <Col>
          <Card className="shadow-sm border-0 text-center h-100">
            <Card.Body>
              <Card.Title className="fw-bold">Rotas mais acessadas</Card.Title>
              <Card.Text className="display-5 fw-bold text-warning">
                <BarChart titulo="" arrNomes={labelsRotas} arrValores={valoresRotas} definicao="Rotas mais acessadas" />
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
