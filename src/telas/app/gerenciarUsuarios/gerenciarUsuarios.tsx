    ...
    return (
        <Container fluid>
            ...
            <div className="d-flex flex-column flex-md-row justify-content-between px-4">
                <h4 className="text-center text-md-start mb-3 mb-md-0">Gerenciar porteiros</h4>
                <div className="d-flex text-center px-2 mb-2 mb-md-0" onClick={vaiParaFormularioPortaria} style={{ display: 'flex', cursor: "pointer", alignItems: 'center', justifyContent: 'center' }}>
